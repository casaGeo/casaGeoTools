    ...
    def test_simple_query(self, mock):
        ...
        mock.assert_called_once_with(
            ...
            json={
                ...
                "queries": [
                    {
                        "direction": cs.DirectionType.OUTGOING,
                        "position": (10.008223, 53.553089),
                        "ranges": [5, 15],
                        "ranges_unit": cs.RangeUnit.MINUTES,
                        "routing_mode": cs.RoutingMode.FAST,
                        "transport_mode": cs.TransportMode.CAR,
                        "unit_system": ct.UnitSystem.METRIC,
                    },
                    {
                        "direction": cs.DirectionType.OUTGOING,
                        "position": (10.66865, 53.86621),
                        "ranges": [3000],
                        "ranges_unit": cs.RangeUnit.METERS,
                        "routing_mode": cs.RoutingMode.FAST,
                        "transport_mode": cs.TransportMode.PEDESTRIAN,
                        "unit_system": ct.UnitSystem.METRIC,
                    },
                    {
                        "direction": cs.DirectionType.OUTGOING,
